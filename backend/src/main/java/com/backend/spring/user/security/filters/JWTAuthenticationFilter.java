package com.backend.spring.user.security.filters;
...
import static com.backend.spring.user.security.SecurityConstants.EXPIRATION_TIME_LONG;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException {
        ...
        String refreshToken = JWT.create()
                .withSubject(user.getUsername())
                .withExpiresAt(new Date(System.currentTimeMillis() + EXPIRATION_TIME_LONG))
                .withIssuer(request.getRequestURI())
                .sign(ALGORITHM);
