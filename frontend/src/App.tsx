...
function App() {
  ...
  // We store the short term access token in the App's context
  // Only the refresh token will be stored as a cookie
  ...
  return (
    <div>
      <Router>
        <AccessTokenContext.Provider value={providerValue}>
          <Navbar />
          <Routes>
